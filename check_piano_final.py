...
preview = read(root / 'departures_piano_preview/departures_full_10tps_piano_v3.nbs')
final = read(root / 'departures_piano_final/departures_full_10tps.nbs')
assert preview == final, 'Approved preview differs from final'
combined = Counter()
for index in range(11):
    length, tempo, events = read(root / f'departures_piano_final/departures_module_{index+1:02d}.nbs')
