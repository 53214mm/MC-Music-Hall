...
def generate_connections(modules, transform, is_north):
    ...
    for i in range(1,11):
        ...
        report.append({'from':i,'to':i+1,'targetTicks':target,'inputIsolator':1,'inputWireDelay':input_delay,
                       'timerDelay':timer_delay,'timerSettings':settings,'timerPositions':p['timer'],
                       'tapPosition':local(i,(19,9,-1)), 'nextRelayPosition':local(i+1,(19,next_h,2)),
                       'linkWireDelay':link_delay,'nextInputRelay':1,
