import unittest
from build_music_hall import rotate_properties, transform, encode_structure, make_shell
...
class HallTests(unittest.TestCase):
    ...
    def test_nbt_roundtrip(self):
        data = NBTReader(encode_structure({(42,0,0):('note_block',{'note':'12','instrument':'harp','powered':'false'},'01')}, 1519)).root()
